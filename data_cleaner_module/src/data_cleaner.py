...
class DataCleaner:
    ...
    def _filter_sheds(self, gdf: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
        """Фильтрация сараев, гаражей, теплиц."""
    ...
    def _filter_outliers(self, gdf: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
        ...
        # Выбросы по высоте (только Источник Б)
